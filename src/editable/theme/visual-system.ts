...
export const visualPresets = {
  'editorial-paper': {
    ...
    mood: 'luxury editorial archive',
    fontDirection: 'premium serif headlines with quiet reader-friendly sans body',
    colors: {
      background: '#f3ead4',
      foreground: '#241109',
      muted: '#978F66',
    ...
    shape: 'layered covers, fine brass borders, and generous margins',
  },
  'luxury-atelier': {
