...
export const pagesContent = {
  home: {
    ...
    hero: {
      ...
      title: ['A polished reading room', 'for useful PDF documents.'],
      description: 'Browse downloadable resources, notes, guides, and document-led posts in a calm editorial interface designed for focused reading.',
      primaryCta: { label: 'Browse PDFs', href: '/pdf' },
      secondaryCta: { label: 'Search library', href: '/search' },
      searchPlaceholder: 'Search PDFs, topics, notes, and resources',
      focusLabel: 'Focus',
      featureCardBadge: 'latest cover rotation',
      featureCardTitle: 'Featured documents shape the homepage like a curated issue.',
      featureCardDescription: 'Recent resources stay easy to scan while every route keeps using the same live post data.',
    },
    intro: {
